...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"runm40bin=" \
		"if test ${m40_addr} = 0x34FE0000; then " \
			"echo Booting M40 from TCM; " \
		"else " \
			"echo Booting M40 from DRAM; " \
			"dcache flush; " \
		"fi; " \
	...
	"runm41bin=" \
		"if test ${m41_addr} = 0x38FE0000; then " \
			"echo Booting M41 from TCM; " \
		"else " \
			"echo Booting M41 from DRAM; " \
			"dcache flush; " \
		"fi; " \
